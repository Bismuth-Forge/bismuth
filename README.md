...
[![Opensuse Openbuild](https://img.shields.io/badge/Openbuild-kwin--bismuth-green)](https://build.opensuse.org/package/show/home:wstephenson:kwin/kwin-script-tiling-bismuth)
...
- If the user is encountering a problem with the installation process when using the distribution packages, they should contact the package maintainer directly.
